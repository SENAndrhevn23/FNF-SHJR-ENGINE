# SH+ANJR ENGINE (SamikHuska + Andre Nicholas Jr)

Welcome to **SH+ANJR ENGINE**. This is a custom engine project based on **Psych Engine v1.0.4**. 
...
## Credits:
### SH+ANJR Team
* **SEN_Andrhevn23** - Lead Developer
* **BestDancer2019** - Developer
